<%-- 
    Document   : index
    Created on : 22/11/2015, 07:40:02 PM
    Author     : Hugo
--%>
                        ...
                        <c:forEach var="cargo" items="${paginacion.items}">
                            <tr>
                                ...
                                <td class="text-center pointer">
                                    <span regId="${cargo.id}" class="glyphicon glyphicon-edit edited"></span>
                                    <span regId="${cargo.id}" class="glyphicon glyphicon-remove deleted"></span>
                                </td>
                            </tr>
                        </c:forEach> 
                    </tbody>
...
<script>
    var path = '${cp}/mantenimiento/cargo/';
    var paginacion = {
...
<script src="${cp}/resources/js/mantenimiento/cargo.js"></script>
