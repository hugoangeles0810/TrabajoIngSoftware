                        ...
                        <c:forEach var="servicios" items="${paginacion.items}">
                            <tr>
                                ...
                                <td class="text-center pointer">
                                    <span regId="${servicios.id}" class="glyphicon glyphicon-edit edited"></span>
                                    <span regId="${servicios.id}" class="glyphicon glyphicon-remove deleted"></span>
                                </td>
                            </tr>
                        </c:forEach> 
                    </tbody>
...
<script src="${cp}/resources/js/mantenimiento/servicios.js"></script>
